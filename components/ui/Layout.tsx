...
import { Home, PlusCircle, LayoutDashboard, Menu, X, Globe, Check, Scale, LogOut, User as UserIcon } from 'lucide-react';
...
export const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row font-sans">
        ...
        <div className="flex items-center gap-4">
            ...
            <div className="relative">
                <button 
                    ...
                    className="text-slate-300 hover:text-white flex items-center gap-1 text-sm font-medium focus:outline-none"
                >
                    <Globe size={18} />
      ...
      {/* Sidebar */}
      <aside
        className={`fixed md:sticky md:top-0 h-screen w-64 bg-slate-900 text-white p-6 flex flex-col gap-8 transition-transform duration-300 z-40 ${
        ...
        <div className="mt-auto border-t border-slate-700 pt-6 space-y-6">
           ...
           <div className="relative w-full hidden md:block">
               <button 
                  ...
                  className="flex items-center gap-3 text-slate-400 hover:text-white transition-colors w-full px-2 py-1 rounded hover:bg-slate-800"
               >
                  <Globe size={18} />
