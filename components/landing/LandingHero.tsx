...
export const LandingHero: React.FC = () => {
  ...
  return (
    <section className="flex-1 flex flex-col justify-center items-center px-6 text-center max-w-4xl mx-auto relative z-10 pb-20 pt-32">
      ...
      <button onClick={login} className="inline-flex items-center gap-2 bg-brand-500 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-brand-600 transition-all shadow-xl shadow-brand-200">
